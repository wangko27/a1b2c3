...
<dl class="hasItem" id="cmp_item_${goods.id}" fore="0">
    ...
    <span class="p-price">${goods.price?string(currencyFormat)}<a class="del-comp-item" skuid="832704" style="visibility: hidden;">删除</a></span>    </dd>
</dl>
</#list>
<#if resultSize lt 4>
<#assign startSeq=(resultSize + 1)>
<#list startSeq..4 as i>
<dl class="item-empty"><dt>${i}</dt><dd>您还可以继续添加</dd></dl>
</#list>
</#if>