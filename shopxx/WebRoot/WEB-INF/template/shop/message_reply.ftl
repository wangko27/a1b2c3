...
<title>${bundle("goods.message.reply")}<#if setting.isShowPoweredInfo> - Powered By SHOP++</#if></title>
	...
	<div class="body messageReply">
		...
		<div class="bodyRight">
			<div class="memberCenterDetail">
				<div class="top">${bundle("goods.message.reply")}</div>
				<div class="middle">
					...
					<form id="messageForm" action="message!save.action" method="post">
						...
						<table class="inputTable">
							<tr>
								<th>
									${bundle("goods.message.reply.receiver")}: 
								</th>
								<td>
