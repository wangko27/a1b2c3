...
<title>${bundle("goods.notify.memberCenter.message.outbox")}<#if setting.isShowPoweredInfo> - Powered By SHOP++</#if></title>
	...
	<div class="body messageOutbox">
	                    ...
	                    <li class="category favorite">
	                  	...
	                  	<li class="message">
	                    	<ul>
	                            ...
	                            <li class="current"><a href="message!outbox.action">${bundle("goods.notify.memberCenter.message.outbox")}</a></li>
	                        </ul>
	                    </li>
	                    <li class="profile">
	                    	<ul>
		...
		<div class="bodyRight">
			<div class="memberCenterDetail">
				<div class="top">${bundle("goods.notify.memberCenter.message.outbox")}</div>
				<div class="middle">
					<div class="blank"></div>
