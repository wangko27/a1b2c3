...
public class SettingUtil {
	...
	public static void writeSetting(Setting setting) {
		...
		if(watermarkImagePathNode == null){
			watermarkImagePathNode = settingElement.addElement("watermarkImagePath");
		}
		...
		if(defaultBigGoodsImagePathNode == null){
			defaultBigGoodsImagePathNode = settingElement.addElement("defaultBigGoodsImagePath");
		}
		if(defaultSmallGoodsImagePathNode == null){
			defaultSmallGoodsImagePathNode = settingElement.addElement("defaultSmallGoodsImagePath");
		}
		...
		watermarkImagePathNode.setText(String.valueOf(setting.getWatermarkImagePath()));
